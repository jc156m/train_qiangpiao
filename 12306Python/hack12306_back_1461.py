...
Options:
    ...
    -c          指定config.ini绝对路径
Example:
    python hack12306.py music
    或者
    python hack12306.py nomusic
"""
    ...
    def specifyTrainNo(self):
        ...
        while self.driver.url == self.ticket_url:
            ...
            try:
                ...
                self.driver.find_by_text(u"预订")[13].click()
                sleep(0.15)
    ...
    def buyTickets(self):
        ...
        try:
            ...
            if m_cmd == 'music':
                ...
                pygame.mixer.music.load(r"Backroad.ogg")
                ...
                tkinter.Button(root, text='success,pay now').pack()
                root.mainloop() 
